...
function Home() {
  return (
    <>
      {/* Enhanced Hero Section with Layered Design - Full Width */}
      <section
        className="hero-section"
        style={{
          background: `linear-gradient(135deg, rgba(30, 64, 175, 0.1) 0%, rgba(30, 64, 175, 0.05) 100%), url('${siteConfig.baseurl}/static/img/logo/homepage_background.png')`,
      ...
      >
        ...
        >
          <img
            src={`${siteConfig.baseurl}/static/img/data_center.jpg`}
            alt="Data Center - CPU and GPU clusters"
            style={{ width: '45%', height: '300px', objectFit: 'cover', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}
          />
          <img
            src={`${siteConfig.baseurl}/static/img/office_workspace.jpg`}
        ...
        {/* Wet Lab Description */}
        <div
          className="lab-description-text"
          style={{
            width: '100%',
            maxWidth: '800px',
            margin: '20px auto',
        ...
        >
          <img
            src={`${siteConfig.baseurl}/static/img/wet_lab1.jpg`}
            alt="Wet Lab - Molecular Biology Research Facility 1"
            style={{ width: '30%', minWidth: '280px', height: '300px', objectFit: 'cover', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}
          />
          <img
            src={`${siteConfig.baseurl}/static/img/wet_lab2.jpg`}
            alt="Wet Lab - Molecular Biology Research Facility 2"
            style={{ width: '30%', minWidth: '280px', height: '300px', objectFit: 'cover', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}
          />
          <img
            src={`${siteConfig.baseurl}/static/img/wet_lab3.jpg`}
      ...
      <section style={{ margin: 0, position: 'relative', background: '#f8f9fa', padding: '16px 0' }}>
        <div
          style={{
            width: '100%',
            maxWidth: '1200px',
        ...
        >
          ...
          >
            <img
              src={`${siteConfig.baseurl}/static/img/logo/hksar.png`}
              alt="Hong Kong SAR"
              style={{
                height: '40px',
                width: 'auto',
            ...
            />
            <img
              src={`${siteConfig.baseurl}/static/img/logo/rgc.png`}
              alt="RGC"
              style={{
                height: '40px',
                width: 'auto',
            ...
            />
            <img
              src={`${siteConfig.baseurl}/static/img/logo/nsfc.png`}
              alt="NSFC"
              style={{
                height: '40px',
                width: 'auto',
            ...
            />
            <img
              src={`${siteConfig.baseurl}/static/img/logo/hkjcct.png`}
              alt="Hong Kong Jockey Club Charities Trust"
              style={{
                height: '40px',
                width: 'auto',
                margin: '2px',
